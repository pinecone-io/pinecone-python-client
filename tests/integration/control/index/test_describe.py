...
class TestDescribeIndex:
    def test_describe_index_when_ready(self, pc, ready_sl_index, create_sl_index_params):
    ...
    def test_describe_index_when_not_ready(self, pc, notready_sl_index, create_sl_index_params):
