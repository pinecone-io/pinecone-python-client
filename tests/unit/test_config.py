...
def test_init_with_positional_args():
    ...
    pinecone.init(api_key, host, environment, log_level, openapi_config)
...
def test_init_with_kwargs():
    ...
    pinecone.init(api_key=api_key, environment=env, host=controller_host, openapi_config=openapi_config)
...
def test_resolution_order_kwargs_over_env_vars():
    ...
    pinecone.init(environment=env, api_key=api_key, host=controller_host)
...
def test_resolution_order_kwargs_over_config_file():
    ...
    with tempfile.NamedTemporaryFile(mode="w") as f:
        ...
        pinecone.init(api_key=kwargs_api_key, config=f.name)
...
def test_init_from_mixed_sources():
    ...
    pinecone.init(host=controller_host)
