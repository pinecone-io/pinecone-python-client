...
**Type:** `Iterator[ListNamespacesResponse]` — A generator that yields namespace objects automatically across all pages. Pagination is handled transparently as you iterate.
