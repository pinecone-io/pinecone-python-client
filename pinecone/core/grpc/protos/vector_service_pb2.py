...
_UPSERTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='conditions', full_name='UpsertRequest.conditions', index=2,
...
_UPSERTREQUEST.fields_by_name['conditions'].message_type = google_dot_protobuf_dot_struct__pb2._STRUCT
