...
class QueryVector(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"filter",b"filter"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"filter",b"filter",u"namespace",b"namespace",u"top_k",b"top_k",u"values",b"values"]) -> None: ...
...
class QueryRequest(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"filter",b"filter"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"filter",b"filter",u"id",b"id",u"include_metadata",b"include_metadata",u"include_values",b"include_values",u"namespace",b"namespace",u"queries",b"queries",u"top_k",b"top_k",u"vector",b"vector"]) -> None: ...
...
class DescribeIndexStatsResponse(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"dimension",b"dimension",u"index_fullness",b"index_fullness",u"namespaces",b"namespaces"]) -> None: ...
