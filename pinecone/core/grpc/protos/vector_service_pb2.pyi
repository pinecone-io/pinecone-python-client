...
class Vector(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["metadata", b"metadata", "sparse_values", b"sparse_values"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "metadata", b"metadata", "sparse_values", b"sparse_values", "values", b"values"]) -> None: ...
...
class ScoredVector(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["metadata", b"metadata", "sparse_values", b"sparse_values"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "metadata", b"metadata", "score", b"score", "sparse_values", b"sparse_values", "values", b"values"]) -> None: ...
...
class RequestUnion(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["RequestUnionInner", b"RequestUnionInner", "delete", b"delete", "update", b"update", "upsert", b"upsert"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["RequestUnionInner", b"RequestUnionInner", "delete", b"delete", "update", b"update", "upsert", b"upsert"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["RequestUnionInner", b"RequestUnionInner"]) -> typing_extensions.Literal["upsert", "delete", "update"] | None: ...
...
class DeleteRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["delete_all", b"delete_all", "filter", b"filter", "ids", b"ids", "namespace", b"namespace"]) -> None: ...
...
class FetchResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["_usage", b"_usage", "namespace", b"namespace", "usage", b"usage", "vectors", b"vectors"]) -> None: ...
...
class ListRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_limit", b"_limit", "_pagination_token", b"_pagination_token", "_prefix", b"_prefix", "limit", b"limit", "pagination_token", b"pagination_token", "prefix", b"prefix"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_limit", b"_limit", "_pagination_token", b"_pagination_token", "_prefix", b"_prefix", "limit", b"limit", "namespace", b"namespace", "pagination_token", b"pagination_token", "prefix", b"prefix"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_limit", b"_limit"]) -> typing_extensions.Literal["limit"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_pagination_token", b"_pagination_token"]) -> typing_extensions.Literal["pagination_token"] | None: ...
    @typing.overload
...
class ListResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_pagination", b"_pagination", "_usage", b"_usage", "pagination", b"pagination", "usage", b"usage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_pagination", b"_pagination", "_usage", b"_usage", "namespace", b"namespace", "pagination", b"pagination", "usage", b"usage", "vectors", b"vectors"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_pagination", b"_pagination"]) -> typing_extensions.Literal["pagination"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_usage", b"_usage"]) -> typing_extensions.Literal["usage"] | None: ...
...
class QueryVector(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["filter", b"filter", "sparse_values", b"sparse_values"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "namespace", b"namespace", "sparse_values", b"sparse_values", "top_k", b"top_k", "values", b"values"]) -> None: ...
...
class QueryRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["filter", b"filter", "sparse_vector", b"sparse_vector"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["filter", b"filter", "id", b"id", "include_metadata", b"include_metadata", "include_values", b"include_values", "namespace", b"namespace", "queries", b"queries", "sparse_vector", b"sparse_vector", "top_k", b"top_k", "vector", b"vector"]) -> None: ...
...
class QueryResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_usage", b"_usage", "usage", b"usage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_usage", b"_usage", "matches", b"matches", "namespace", b"namespace", "results", b"results", "usage", b"usage"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_usage", b"_usage"]) -> typing_extensions.Literal["usage"] | None: ...
...
class Usage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["_read_units", b"_read_units", "read_units", b"read_units"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_read_units", b"_read_units", "read_units", b"read_units"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_read_units", b"_read_units"]) -> typing_extensions.Literal["read_units"] | None: ...
...
class UpdateRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["set_metadata", b"set_metadata", "sparse_values", b"sparse_values"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "namespace", b"namespace", "set_metadata", b"set_metadata", "sparse_values", b"sparse_values", "values", b"values"]) -> None: ...
...
class DescribeIndexStatsResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["dimension", b"dimension", "index_fullness", b"index_fullness", "namespaces", b"namespaces", "total_vector_count", b"total_vector_count"]) -> None: ...
