...
class QueryRequest(google___protobuf___message___Message):
    ...
    def HasField(self, field_name: typing_extensions___Literal[u"filter",b"filter"]) -> builtin___bool: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"filter",b"filter",u"include_data",b"include_data",u"include_metadata",b"include_metadata",u"namespace",b"namespace",u"queries",b"queries",u"top_k",b"top_k"]) -> None: ...
