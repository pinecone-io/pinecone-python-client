...
def lazy_import():
    ...
    globals()['DocumentContextUnitModel'] = DocumentContextUnitModel


from typing import Dict, Literal, Tuple, Set, Any, Type, TypeVar
from pinecone.openapi_support import PropertyValidationTypedDict, cached_class_property

T = TypeVar("T", bound="ContextOptionsModel")


class ContextOptionsModel(ModelComposed):
    ...
    def discriminator(cls):
        lazy_import()
        val = {
            'DocumentContextUnitModel': DocumentContextUnitModel,
            'document': DocumentContextUnitModel,
        }
        if not val:
            return None
        return {'unit': val}
    ...
    def _from_openapi_data(cls: Type[T], *args, **kwargs) -> T:  # noqa: E501
        """ContextOptionsModel - a model defined in OpenAPI

        Keyword Args:
            unit (str): The search result context unit. Always \"document\".
