...
class ListDocumentsResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], namespace, documents, usage, lsn_status, *args, **kwargs) -> T:  # noqa: E501
        """ListDocumentsResponse - a model defined in OpenAPI
