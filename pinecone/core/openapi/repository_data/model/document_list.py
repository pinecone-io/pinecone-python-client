...
class DocumentList(ModelSimple):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        Args:
            args[0] ([Document]): The list of documents that exist in the Repository namespace..  # noqa: E501

        Keyword Args:
            value ([Document]): The list of documents that exist in the Repository namespace..  # noqa: E501
