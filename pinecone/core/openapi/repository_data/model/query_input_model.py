...
def lazy_import():
    ...
    globals()['QueryInputModelOneOf'] = QueryInputModelOneOf


from typing import Dict, Literal, Tuple, Set, Any, Type, TypeVar
from pinecone.openapi_support import PropertyValidationTypedDict, cached_class_property

T = TypeVar("T", bound="QueryInputModel")


class QueryInputModel(ModelComposed):
    ...
    def _from_openapi_data(cls: Type[T], *args, **kwargs) -> T:  # noqa: E501
        """QueryInputModel - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            text (str): The query string used to search. [optional]  # noqa: E501
        """
