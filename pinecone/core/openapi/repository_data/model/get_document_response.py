...
T = TypeVar("T", bound="GetDocumentResponse")
...
class GetDocumentResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], namespace, document, usage, lsn_status, *args, **kwargs) -> T:  # noqa: E501
        """GetDocumentResponse - a model defined in OpenAPI

        Args:
            namespace (str): Namespace of the document to fetch.
            document (Document):
            usage (Usage):
    ...
    @convert_js_args_to_python_args
    def __init__(self, namespace, document, usage, lsn_status, *args, **kwargs) -> None:  # noqa: E501
        """GetDocumentResponse - a model defined in OpenAPI
