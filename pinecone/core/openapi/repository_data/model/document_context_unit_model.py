...
T = TypeVar("T", bound="DocumentContextUnitModel")


class DocumentContextUnitModel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], unit, *args, **kwargs) -> T:  # noqa: E501
        """DocumentContextUnitModel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, unit, *args, **kwargs) -> None:  # noqa: E501
        """DocumentContextUnitModel - a model defined in OpenAPI
