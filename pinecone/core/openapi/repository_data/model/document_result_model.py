...
def lazy_import():
    ...
    globals()['MatchedChunkModel'] = MatchedChunkModel


from typing import Dict, Literal, Tuple, Set, Any, Type, TypeVar
from pinecone.openapi_support import PropertyValidationTypedDict, cached_class_property

T = TypeVar("T", bound="DocumentResultModel")


class DocumentResultModel(ModelNormal):
    ...
    def openapi_types(cls):
        ...
        return {
            ...
            'id': (str,),  # noqa: E501
            'document': ({str: (bool, dict, float, int, list, str, none_type)},),  # noqa: E501
            'matching_chunks': ([MatchedChunkModel],),  # noqa: E501
        }
    ...
    attribute_map: Dict[str, str] = {
        ...
        'matching_chunks': 'matching_chunks',  # noqa: E501
    }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], score, id, document, matching_chunks, *args, **kwargs) -> T:  # noqa: E501
        """DocumentResultModel - a model defined in OpenAPI

        Args:
            score (float): The relevance of the document to the query.
            id (str): The ID of the document.
            document ({str: (bool, dict, float, int, list, str, none_type)}): The document JSON, which may include the entire document or only a relevant part of it.
            matching_chunks ([MatchedChunkModel]): List of chunks within the document that matched the query.
        ...
        self.matching_chunks = matching_chunks
    ...
    @convert_js_args_to_python_args
    def __init__(self, score, id, document, matching_chunks, *args, **kwargs) -> None:  # noqa: E501
        """DocumentResultModel - a model defined in OpenAPI
