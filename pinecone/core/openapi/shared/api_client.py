...
from pinecone.core.openapi.shared.exceptions import PineconeApiTypeError, PineconeApiValueError, PineconeApiException
from pinecone.core.openapi.shared.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
