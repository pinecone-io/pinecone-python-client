...
class SparseEmbedding(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sparse_values, sparse_indices, vector_type, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, sparse_values, sparse_indices, vector_type, *args, **kwargs):  # noqa: E501
        """SparseEmbedding - a model defined in OpenAPI
