...
T = TypeVar("T", bound="EmbeddingsList")
...
class EmbeddingsList(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of EmbeddingsList.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], model, vector_type, data, usage, *args, **kwargs) -> T:  # noqa: E501
        """EmbeddingsList - a model defined in OpenAPI

        Args:
            model (str): The model used to generate the embeddings
            vector_type (str): Indicates whether the response data contains 'dense' or 'sparse' embeddings.
    ...
    @convert_js_args_to_python_args
    def __init__(self, model, vector_type, data, usage, *args, **kwargs) -> None:  # noqa: E501
        """EmbeddingsList - a model defined in OpenAPI
