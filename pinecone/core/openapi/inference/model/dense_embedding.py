...
T = TypeVar("T", bound="DenseEmbedding")


class DenseEmbedding(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of DenseEmbedding.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], values, vector_type, *args, **kwargs) -> T:  # noqa: E501
        """DenseEmbedding - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, values, vector_type, *args, **kwargs) -> None:  # noqa: E501
        """DenseEmbedding - a model defined in OpenAPI
