...
class EmbedRequest(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of EmbedRequest.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], model, inputs, *args, **kwargs) -> T:  # noqa: E501
        ...
        Keyword Args:
            ...
            parameters (Dict[str, Any]): Additional model-specific parameters. Refer to the [model guide](https://docs.pinecone.io/guides/index-data/create-an-index#embedding-models) for available model parameters. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, model, inputs, *args, **kwargs) -> None:  # noqa: E501
        """EmbedRequest - a model defined in OpenAPI
