...
class CreateIndexForModelRequest(ModelNormal):
    ...
    allowed_values = {("cloud",): {"GCP": "gcp", "AWS": "aws", "AZURE": "azure"}}

    validations = {("name",): {"max_length": 45, "min_length": 1}}
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, cloud, region, embed, *args, **kwargs):  # noqa: E501
