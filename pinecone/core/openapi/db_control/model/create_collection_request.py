...
class CreateCollectionRequest(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of CreateCollectionRequest.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], name, source, *args, **kwargs) -> T:  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, source, *args, **kwargs) -> None:  # noqa: E501
        """CreateCollectionRequest - a model defined in OpenAPI
