...
class PaginationResponse(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of PaginationResponse.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], next, *args, **kwargs) -> T:  # noqa: E501
        """PaginationResponse - a model defined in OpenAPI

        Args:
            next (str): The token to use to retrieve the next page of results.
    ...
    @convert_js_args_to_python_args
    def __init__(self, next, *args, **kwargs) -> None:  # noqa: E501
        """PaginationResponse - a model defined in OpenAPI
