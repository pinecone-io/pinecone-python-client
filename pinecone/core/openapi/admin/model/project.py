...
class Project(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], id, name, max_pods, force_encryption_with_cmek, organization_id, *args, **kwargs) -> T:  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, max_pods, force_encryption_with_cmek, organization_id, *args, **kwargs) -> None:  # noqa: E501
        """Project - a model defined in OpenAPI
