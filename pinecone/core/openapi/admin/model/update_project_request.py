...
class UpdateProjectRequest(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of UpdateProjectRequest.
    ...
    def _from_openapi_data(cls: Type[T], *args, **kwargs) -> T:  # noqa: E501
        ...
        Keyword Args:
            ...
            name (str): The name of the new project. [optional]  # noqa: E501
            max_pods (int): The maximum number of Pods that can be created in the project.  [optional]  # noqa: E501
            force_encryption_with_cmek (bool): Whether to force encryption with a customer-managed encryption key (CMEK). Once enabled, CMEK encryption cannot be disabled.  [optional]  # noqa: E501
        """
