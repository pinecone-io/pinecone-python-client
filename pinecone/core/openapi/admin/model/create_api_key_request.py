...
class CreateAPIKeyRequest(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of CreateAPIKeyRequest.
    ...
    def _from_openapi_data(cls: Type[T], name, *args, **kwargs) -> T:  # noqa: E501
        ...
        Args:
            name (str): The name of the API key. The name must be 1-80 characters long.
        ...
        Keyword Args:
            ...
            roles ([str]): The roles to create the API key with. Default is `[\"ProjectEditor\"]`.  [optional]  # noqa: E501
        """
