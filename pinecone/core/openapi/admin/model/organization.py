...
class Organization(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], id, name, plan, payment_status, created_at, support_tier, *args, **kwargs) -> T:  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, plan, payment_status, created_at, support_tier, *args, **kwargs) -> None:  # noqa: E501
        """Organization - a model defined in OpenAPI
