...
class APIKeyWithSecret(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of APIKeyWithSecret.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], key, value, *args, **kwargs) -> T:  # noqa: E501
        """APIKeyWithSecret - a model defined in OpenAPI

        Args:
            key (APIKey):
            value (str): The value to use as an API key. New keys will have the format `\"pckey_<public-label>_<unique-key>\"`. The entire string should be used when authenticating.
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, value, *args, **kwargs) -> None:  # noqa: E501
        """APIKeyWithSecret - a model defined in OpenAPI
