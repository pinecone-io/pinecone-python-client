...
class APIKey(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of APIKey.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], id, name, project_id, roles, *args, **kwargs) -> T:  # noqa: E501
        """APIKey - a model defined in OpenAPI

        Args:
            id (str): The unique ID of the API key.
            name (str): The name of the API key.
            project_id (str): The ID of the project containing the API key.
            roles ([str]): The roles assigned to the API key.
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, project_id, roles, *args, **kwargs) -> None:  # noqa: E501
        """APIKey - a model defined in OpenAPI
