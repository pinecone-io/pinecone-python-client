    ...
    def __init__(self, api_client=None) -> None:
        ...
        def __fetch_by_metadata(
            ...
            **kwargs: ExtraOpenApiKwargsTypedDict,
            ...
            >>> thread = api.fetch_by_metadata(fetch_by_metadata_request, x_pinecone_api_version="2025-10", async_req=True)
            >>> result = thread.get()
...
class AsyncioVectorOperationsApi:
    ...
    def __init__(self, api_client=None) -> None:
        ...
        self.fetch_by_metadata = _AsyncioEndpoint(
            settings={
                "response_type": (FetchByMetadataResponse,),
                "auth": ["ApiKeyAuth"],
                "endpoint_path": "/vectors/fetch_by_metadata",
