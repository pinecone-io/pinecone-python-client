...
T = TypeVar("T", bound="SearchRecordsResponseResult")
...
class SearchRecordsResponseResult(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of SearchRecordsResponseResult.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], hits, *args, **kwargs) -> T:  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, hits, *args, **kwargs) -> None:  # noqa: E501
        """SearchRecordsResponseResult - a model defined in OpenAPI
