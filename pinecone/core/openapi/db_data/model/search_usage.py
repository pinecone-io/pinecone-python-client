...
class SearchUsage(ModelNormal):
    ...
    validations: Dict[Tuple[str, ...], PropertyValidationTypedDict] = {
        ("read_units",): {"inclusive_minimum": 0},
        ("embed_total_tokens",): {"inclusive_minimum": 0},
        ("rerank_units",): {"inclusive_minimum": 0},
    }
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of SearchUsage.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], read_units, *args, **kwargs) -> T:  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, read_units, *args, **kwargs) -> None:  # noqa: E501
        """SearchUsage - a model defined in OpenAPI
