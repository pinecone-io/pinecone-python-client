...
class UpsertRequest(ModelNormal):
    ...
    validations: Dict[Tuple[str, ...], PropertyValidationTypedDict] = {("vectors",): {}}
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of UpsertRequest.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], vectors, *args, **kwargs) -> T:  # noqa: E501
        ...
        Keyword Args:
            ...
            namespace (str): The namespace where you upsert records. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, vectors, *args, **kwargs) -> None:  # noqa: E501
        """UpsertRequest - a model defined in OpenAPI
