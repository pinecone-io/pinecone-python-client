...
T = TypeVar("T", bound="VectorQuery")


class VectorQuery(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of VectorQuery.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], type, field, *args, **kwargs) -> T:  # noqa: E501
        """VectorQuery - a model defined in OpenAPI

        Args:
            type (str): The query type. Must be the string value `\"vector\"`.
            field (str): The vector field to search.
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, field, *args, **kwargs) -> None:  # noqa: E501
        """VectorQuery - a model defined in OpenAPI
