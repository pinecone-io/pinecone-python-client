...
T = TypeVar("T", bound="SparseValues")
...
class SparseValues(ModelNormal):
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of SparseValues.
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], indices, values, *args, **kwargs) -> T:  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, indices, values, *args, **kwargs) -> None:  # noqa: E501
        """SparseValues - a model defined in OpenAPI
