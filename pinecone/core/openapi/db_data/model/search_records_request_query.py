...
T = TypeVar("T", bound="SearchRecordsRequestQuery")
...
class SearchRecordsRequestQuery(ModelNormal):
    ...
    validations: Dict[Tuple[str, ...], PropertyValidationTypedDict] = {("id",): {"max_length": 512}}
    ...
    def __new__(cls: Type[T], *args: Any, **kwargs: Any) -> T:
        """Create a new instance of SearchRecordsRequestQuery.
    ...
    def _from_openapi_data(cls: Type[T], top_k, *args, **kwargs) -> T:  # noqa: E501
        ...
        Keyword Args:
            ...
            inputs (Dict[str, Any]): [optional]  # noqa: E501
