...
T = TypeVar("T", bound="DocumentSchemaFieldMap")


class DocumentSchemaFieldMap(ModelNormal):
    ...
    def additional_properties_type(cls):
        ...
        """
        return ({str: (bool, dict, float, int, list, str, none_type)},)  # noqa: E501
    ...
    def _from_openapi_data(cls: Type[T], *args, **kwargs) -> T:  # noqa: E501
        """DocumentSchemaFieldMap - a model defined in OpenAPI
