...
def lazy_import():
    ...
    from pinecone.core.openapi.repository_control.model.repository_model_spec import (
        RepositoryModelSpec,
    )
    ...
    globals()["RepositoryModelSpec"] = RepositoryModelSpec
    globals()["RepositoryModelStatus"] = RepositoryModelStatus
...
class RepositoryModel(ModelNormal):
    ...
    def openapi_types(cls):
        ...
        return {
            "name": (str,),  # noqa: E501
            "host": (str,),  # noqa: E501
            "spec": (RepositoryModelSpec,),  # noqa: E501
            "status": (RepositoryModelStatus,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls: Type[T], name, host, spec, status, *args, **kwargs) -> T:  # noqa: E501
        """RepositoryModel - a model defined in OpenAPI
        ...
        Args:
            ...
            host (str): The URL address where the repository is hosted.
            spec (RepositoryModelSpec):
            status (RepositoryModelStatus):
        ...
        Keyword Args:
            ...
            schema (DocumentSchema): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, host, spec, status, *args, **kwargs) -> None:  # noqa: E501
        """RepositoryModel - a model defined in OpenAPI
