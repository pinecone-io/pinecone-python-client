...
def lazy_import():
    ...
    globals()["RepositoryModel"] = RepositoryModel


from typing import Dict, Literal, Tuple, Set, Any, Type, TypeVar
from pinecone.openapi_support import PropertyValidationTypedDict, cached_class_property

T = TypeVar("T", bound="RepositoryList")
...
class RepositoryList(ModelNormal):
    ...
    def openapi_types(cls):
        ...
        lazy_import()
        return {
            "repositories": ([RepositoryModel],)  # noqa: E501
        }
    ...
    def _from_openapi_data(cls: Type[T], *args, **kwargs) -> T:  # noqa: E501
        ...
        Keyword Args:
            ...
            repositories ([RepositoryModel]): [optional]  # noqa: E501
        """
