...
class IndexListMeta(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, metric, dimension, capacity_mode, host, *args, **kwargs):  # noqa: E501
        """IndexListMeta - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, metric, dimension, capacity_mode, host, *args, **kwargs):  # noqa: E501
        """IndexListMeta - a model defined in OpenAPI
