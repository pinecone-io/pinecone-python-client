...
class CreateIndexRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'spec': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, dimension, metric, spec, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            metric (IndexMetric):
            spec ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Spec objects describe how the index should be deployed
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, dimension, metric, spec, *args, **kwargs):  # noqa: E501
        """CreateIndexRequest - a model defined in OpenAPI
