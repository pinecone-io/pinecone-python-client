...
class TextUpsertRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, vectors, *args, **kwargs):  # noqa: E501
        """TextUpsertRequest - a model defined in OpenAPI

        Args:
            vectors ([TextVector]): An array containing the vectors to upsert. Recommended batch limit is 100 vectors.
