...
class TextQueryRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'id': (str,),  # noqa: E501
            'sparse_vector': ({str: (int,)},),  # noqa: E501
    ...
    def _from_openapi_data(cls, top_k, *args, **kwargs):  # noqa: E501
        """TextQueryRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            sparse_vector ({str: (int,)}): The query sparse values.. [optional]  # noqa: E501
            alpha (float): [optional]  # noqa: E501
        """
