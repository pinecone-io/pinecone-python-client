...
class SingleQueryResults(BaseModel):
    ...
    __properties = ["matches", "namespace"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SingleQueryResults:
        """Create an instance of SingleQueryResults from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SingleQueryResults:
        """Create an instance of SingleQueryResults from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SingleQueryResults.parse_obj(obj)

        _obj = SingleQueryResults.parse_obj(
            {
