...
class ScoredVector(BaseModel):
    ...
    values: Optional[conlist(Union[StrictFloat, StrictInt])] = Field(
        None, description="This is the vector data, if it is requested."
    )
    sparse_values: Optional[SparseValues] = Field(None, alias="sparseValues")
    metadata: Optional[Dict[str, Any]] = Field(None, description="This is the metadata, if it is requested.")
    __properties = ["id", "score", "values", "sparseValues", "metadata"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScoredVector:
        """Create an instance of ScoredVector from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScoredVector:
        """Create an instance of ScoredVector from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScoredVector.parse_obj(obj)

        _obj = ScoredVector.parse_obj(
            {
                "id": obj.get("id"),
                "score": obj.get("score"),
