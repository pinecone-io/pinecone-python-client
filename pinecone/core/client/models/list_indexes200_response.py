...
class ListIndexes200Response(BaseModel):
    """
    ListIndexes200Response
    """

    databases: Optional[conlist(IndexMeta)] = None
    __properties = ["databases"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListIndexes200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListIndexes200Response:
        """Create an instance of ListIndexes200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListIndexes200Response.parse_obj(obj)

        _obj = ListIndexes200Response.parse_obj(
            {
                "databases": [IndexMeta.from_dict(_item) for _item in obj.get("databases")]
