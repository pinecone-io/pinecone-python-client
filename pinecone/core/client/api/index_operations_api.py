    ...
    def __init__(self, api_client=None):
        ...
        def __describe_collection(
            ...
            **kwargs
            ...
            >>> thread = api.describe_collection(UNKNOWN_PARAMETER_NAME, async_req=True)
            >>> result = thread.get()

            Args:
                UNKNOWN_PARAMETER_NAME (): The name of the collection
        ...
        self.describe_collection = _Endpoint(
            ...
            root_map={
                ...
                'attribute_map': {
                    'UNKNOWN_PARAMETER_NAME': 'collectionName',
                },
                'location_map': {
