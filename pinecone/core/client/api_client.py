...
import pinecone.core.client.models
from pinecone.core.client import rest
from pinecone.core.client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pinecone.core.client.models, klass)
