...
class SnapshotClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Call = channel.unary_unary(
                '/core.SnapshotClient/Call',
                request_serializer=core__pb2.SnapshotRequest.SerializeToString,
                response_deserializer=core__pb2.SnapshotResponse.FromString,
                )
...
def add_SnapshotClientServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Call': grpc.unary_unary_rpc_method_handler(
                    servicer.Call,
                    request_deserializer=core__pb2.SnapshotRequest.FromString,
                    response_serializer=core__pb2.SnapshotResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'core.SnapshotClient', rpc_method_handlers)
...
class SnapshotClient(object):
    ...
    def Call(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/core.SnapshotClient/Call',
            core__pb2.SnapshotRequest.SerializeToString,
            core__pb2.SnapshotResponse.FromString,
