...
class DenseVector(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"id",b"id",u"values",b"values"]) -> None: ...
...
class ScoredVector(google___protobuf___message___Message):
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"id",b"id",u"score",b"score",u"values",b"values"]) -> None: ...
...
class QueryRequest(google___protobuf___message___Message):
    ...
    class QueryVector(google___protobuf___message___Message):
        ...
        def ClearField(self, field_name: typing_extensions___Literal[u"namespace",b"namespace",u"top_k",b"top_k",u"vector",b"vector"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"include_data",b"include_data",u"queries",b"queries",u"request_default_namespace",b"request_default_namespace",u"request_default_top_k",b"request_default_top_k",u"request_id",b"request_id"]) -> None: ...
