# These exceptions are copied out of the generated openapi client code. 
# They have been copied here so that we can have a single source of truth
# for exceptions and avoid having multiple classes with the same name
# as we generate more packages from the openapi specs.
