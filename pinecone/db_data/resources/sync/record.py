...
class RecordResource(PluginAware):
    """Resource for record operations on a Pinecone index."""

    def __init__(self, vector_api: VectorOperationsApi, config, openapi_config):
