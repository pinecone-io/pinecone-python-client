...
import logging
import json
from typing import Union, List, Optional, Dict, Any, Literal, Iterator
...
class VectorResource:
    """Resource for vector-centric operations on a Pinecone index."""

    def __init__(self, vector_api, api_client, openapi_config, pool_threads: int):
