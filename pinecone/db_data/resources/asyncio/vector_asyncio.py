...
class VectorResourceAsyncio(PluginAware):
    """Resource for vector operations on a Pinecone index (async)."""
    ...
    async def upsert_from_dataframe(
        ...
        Raises:
            NotImplementedError: This method is not implemented for asyncio.
        """
    ...
    async def delete(
        ...
        **kwargs,
        ...
        Examples:
            >>> await index.vector.delete(ids=['id1', 'id2'], namespace='my_namespace')
            >>> await index.vector.delete(delete_all=True, namespace='my_namespace')
            >>> await index.vector.delete(filter={'key': 'value'}, namespace='my_namespace')
        """
    ...
    async def fetch(self, ids: list[str], namespace: str | None = None, **kwargs) -> FetchResponse:
        ...
        Examples:
            >>> await index.vector.fetch(ids=['id1', 'id2'], namespace='my_namespace')
            >>> await index.vector.fetch(ids=['id1', 'id2'])
        """
        args_dict = parse_non_empty_args([("namespace", namespace)])
    ...
    async def fetch_by_metadata(
        ...
        **kwargs,
        ...
        Examples:
            >>> await index.vector.fetch_by_metadata(
    ...
    async def query(
        ...
        **kwargs,
        ...
        Returns:
            ...
            ScoredVector objects, and namespace name.

        Examples:
            >>> await index.vector.query(vector=[1, 2, 3], top_k=10, namespace='my_namespace')
            >>> await index.vector.query(id='id1', top_k=10, namespace='my_namespace')
            >>> await index.vector.query(vector=[1, 2, 3], top_k=10, namespace='my_namespace',
            ...                    filter={'key': 'value'})
        """
    ...
    async def query_namespaces(
        ...
        **kwargs,
        ...
        Examples:
            >>> await index.vector.query_namespaces(
            ...     vector=[1, 2, 3],
            ...     namespaces=['ns1', 'ns2'],
            ...     metric='cosine',
            ...     top_k=10
    ...
    async def update(
        ...
        **kwargs,
        ...
        Examples:
            >>> await index.vector.update(id='id1', values=[1, 2, 3], namespace='my_namespace')
            >>> await index.vector.update(id='id1', set_metadata={'key': 'value'},
            ...                     namespace='my_namespace')
        """
    ...
    async def list_paginated(
        ...
        **kwargs,
        ...
        Examples:
            >>> results = await index.vector.list_paginated(prefix='99', limit=5,
            ...                                       namespace='my_namespace')
    ...
    async def list(self, **kwargs) -> AsyncIterator[list[str]]:
        ...
        an async generator that yields a list of the matching vector ids in each page of results.
        ...
        Examples:
            >>> async for ids in index.vector.list(prefix='99', limit=5,
            ...                              namespace='my_namespace'):
            ...     print(ids)
            ['99', '990', '991', '992', '993']
            ['994', '995', '996', '997', '998']
